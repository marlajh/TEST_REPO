...
The first output dataset goes on the first tab of the excel report document, with that tab labelled '3+ Crisis,IP and IT-30 days'.  Sort order rows by 'crisis_auths_past30day__excludes_IP_IT' (descending order)

The second output dataset goes on the second tab of the excel report document, with that tab labelled '2+ IT or 5+ Crisis,IP,IT 30 days'. Sort order rows by KCID ( ascending order)
